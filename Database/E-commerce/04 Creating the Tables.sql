...
(
    ...
    attributeProductVariableProductVariableId INT REFERENCES [SQM_GENERAL].[Tbl_ProductVariables](productVariableId) NOT NULL,
...
(
    ...
    stockMovementOrderId INT REFERENCES [SQM_GENERAL].[Tbl_PaymentOrders](orderId), 
...
CREATE TABLE [SQM_GENERAL].[Tbl_PriceHistory] (
    priceHistoryId INT IDENTITY(1,1) PRIMARY KEY,
    priceHistoryProductVariableId INT NOT NULL,
    priceHistoryOldPrice DECIMAL(18,2) NOT NULL,
    priceHistoryNewPrice DECIMAL(18,2) NOT NULL,
    priceHistoryChangeDate DATETIME NOT NULL,
    priceHistoryModifierId INT NULL,
    FOREIGN KEY (priceHistoryProductVariableId) REFERENCES [SQM_GENERAL].[Tbl_ProductVariables](productVariableId)
);
GO