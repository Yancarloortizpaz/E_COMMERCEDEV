...
namespace Ecom_Presentation.Controllers
{
    ...
    public class ProductIdentificators_Controller : ControllerBase
    {
        ...
        public async Task<IActionResult> Nuevo([FromBody] ProductIdentificators_DTOS dto)
        {
            try
            {
                var result = await _service.NUEVO_PRODUCTIDENTIFICATORS_ASYNC(dto);
        ...
        public async Task<IActionResult> Actualizar([FromBody] ProductIdentificators_DTOS dto)
        {
            try
            {
                var result = await _service.ACTUALIZAR_PRODUCTIDENTIFICATORS_ASYNC(dto);
        ...
        public async Task<IActionResult> Eliminar(int id, int modificatorId)
        {
            try
            {
                var result = await _service.ELIMINAR_PRODUCTIDENTIFICATORS_ASYNC(id, modificatorId);
