...
namespace Ecom_Presentation.Controllers
{
    ...
    {
        private readonly Category_Services _service;

        public Category_Controller(Category_Services service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> Nuevo([FromBody] Category_DTOS dto)
        {
            try
            {
                var result = await _service.NUEVO_CATEGORY_ASYNC(dto);
        ...
        public async Task<IActionResult> Actualizar([FromBody] Category_DTOS dto)
        {
            try
            {
                var result = await _service.ACTUALIZAR_CATEGORY_ASYNC(dto);
