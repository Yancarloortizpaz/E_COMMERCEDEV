...
namespace Ecom_Aplication.Services
{
    public class ProductVariables_Services
    {
        ...
        public async Task<IEnumerable<ProductVariables_DTOS>> LISTAR_PRODUCTVARIABLES_ASYNC()
        {
        ...
        public async Task<ProductVariables_DTOS?> OBTENER_PRODUCTVARIABLE_BY_ID_ASYNC(int productVariableId)
        {
            var data = await _repository.FILTRAR_PRODUCTVARIABLES_ASYNC(productVariableId.ToString(), null);
            ...
            return data.Select(v => new ProductVariables_DTOS
            {
                ...
                productVariableModificationDate = v.productVariableModificationDate,
                productVariableStatusId = v.productVariableStatusId
            }).FirstOrDefault(v => v.productVariableId == productVariableId);
        }

        public async Task<IEnumerable<ProductVariables_DTOS>> FILTRAR_PRODUCTVARIABLES_ASYNC(string searchTerm, bool? statusId)
        {
